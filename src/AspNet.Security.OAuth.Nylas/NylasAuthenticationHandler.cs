...
{
    public class NylasAuthenticationHandler : OAuthHandler<NylasAuthenticationOptions>
    {
        public NylasAuthenticationHandler(
            [NotNull] IOptionsMonitor<NylasAuthenticationOptions> options,
